...
@mailupinc/bee-emailonacid-plugin-statsd-reporter
...
**Note:** Version bump only for package
@researchgate/emailonacid-plugin-statsd-reporter
...
**Note:** Version bump only for package emailonacid-plugin-statsd-reporter
